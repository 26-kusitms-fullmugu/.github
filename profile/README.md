...
|:--:|:----:|:----:|:----:|
|타겟|나누미(결식아동)|학생 개인 회원|투자 의향이 있는 스타트업, 중소 기업, 기업에 협업 프로젝트 아이디어 결과물을 판매할 학생 단체 회원|
|  |나누미(결식아동)|학생 개인 회원|투자 의향이 있는 스타트업, 중소 기업, 기업에 협업 프로젝트 아이디어 결과물을 판매할 학생 단체 회원|
...
|후원가능 식당 리스트|후원자들이 식사를 후원하고 싶은 식당을 볼 수 있는 리스트 기능
|정보공유|착한 식당 등 서스펜디드 밀 & 결식아동들과 관련한 유용한 정보를 알려주는 기능
